...
namespace com.wx.redis
{
    public class RedisZSet
    {
        ...
        {
            return RedisBase.Client.AddItemToSortedSet(key, value);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.AddItemToSortedSet(key, value, score);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.AddRangeToSortedSet(key, values, score);
        }
        /// <summary>
        /// 为key添加values集合，values集合中每个value的分数设置为score
        /// </summary>
        ...
        {
            return RedisBase.Client.GetAllItemsFromSortedSet(key);
        }
        /// <summary>
        /// 获取key的所有集合，倒叙输出
        /// </summary>
        ...
        {
            return RedisBase.Client.GetAllItemsFromSortedSetDesc(key);
        }
        /// <summary>
        /// 获取可以的说有集合，带分数
        /// </summary>
        ...
        {
            return RedisBase.Client.GetAllWithScoresFromSortedSet(key);
        }
        /// <summary>
        /// 获取key为value的下标值
        /// </summary>
        ...
        {
            return RedisBase.Client.GetItemIndexInSortedSet(key, value);
        }
        /// <summary>
        /// 倒叙排列获取key为value的下标值
        /// </summary>
        ...
        {
            return RedisBase.Client.GetItemIndexInSortedSetDesc(key, value);
        }
        /// <summary>
        /// 获取key为value的分数
        /// </summary>
        ...
        {
            return RedisBase.Client.GetItemScoreInSortedSet(key, value);
        }
        /// <summary>
        /// 获取key所有集合的数据总数
        /// </summary>
        ...
        {
            return RedisBase.Client.GetSortedSetCount(key);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.GetSortedSetCount(key, fromScore, toScore);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.GetRangeFromSortedSetByHighestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.GetRangeFromSortedSetByLowestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.GetRangeWithScoresFromSortedSetByHighestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.GetRangeWithScoresFromSortedSetByLowestScore(key, fromscore, toscore);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.GetRangeFromSortedSet(key, fromRank, toRank);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.GetRangeFromSortedSetDesc(key, fromRank, toRank);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.GetRangeWithScoresFromSortedSet(key, fromRank, toRank);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.GetRangeWithScoresFromSortedSetDesc(key, fromRank, toRank);
        }
        #endregion
        #region 删除
        /// <summary>
        ...
        {
            return RedisBase.Client.RemoveItemFromSortedSet(key, value);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.RemoveRangeFromSortedSet(key, minRank, maxRank);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.RemoveRangeFromSortedSetByScore(key, fromscore, toscore);
        }
        /// <summary>
        /// 删除key集合中分数最大的数据
        /// </summary>
        ...
        {
            return RedisBase.Client.PopItemWithHighestScoreFromSortedSet(key);
        }
        /// <summary>
        /// 删除key集合中分数最小的数据
        /// </summary>
        ...
        {
            return RedisBase.Client.PopItemWithLowestScoreFromSortedSet(key);
        }
        #endregion
        #region 其它
        /// <summary>
        ...
        {
            return RedisBase.Client.SortedSetContainsItem(key, value);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.IncrementItemInSortedSet(key, value, scoreBy);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.StoreIntersectFromSortedSets(newkey, keys);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.StoreUnionFromSortedSets(newkey, keys);
        }
        #endregion
    }
}
