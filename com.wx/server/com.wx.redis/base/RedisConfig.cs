...
namespace com.wx.redis
{
    public sealed class RedisConfig : ConfigurationSection
    {
        ...
        public static RedisConfig GetConfig(string sectionName)
        {
            ...
            RedisConfig section = null;
            try
            {
                Console.WriteLine(ConfigurationManager.GetSection(sectionName));
                section = (RedisConfig)ConfigurationManager.GetSection(sectionName);
            }
            catch (Exception ex)
            {
                Console.WriteLine("read section error:" + ex.Message);
            }
            if (section == null)
