...
namespace com.wx.redis
{
    public class RedisHelper : IDisposable
    {
        ...
        //    get
        //    {
        //        if (_client == null) _client = new RedisClient("192.168.0.182", 6379);
        //        return _client;
        //    }
        //}
        ...
        */
        ...
        {
            return RedisBase.Client.Set<string>(key, value, dt);
        }
        ...
        public static string getValueString(string key)
        {
            ...
            string value = RedisBase.Client.GetValue(key);
            return value;
        ...
        //{
        //    byte[] value = RedisBase.Client.Get(key);
        //    return value;
        //}
        /// <summary>
        /// 获得某个hash型key下的所有字段
        ...
        {
            List<string> hashFields = RedisBase.Client.GetHashKeys(hashId);
            return hashFields;
        }
        /// <summary>
        /// 获得某个hash型key下的所有值
        ...
        {
            List<string> hashValues = RedisBase.Client.GetHashKeys(hashId);
            return hashValues;
        }
        /// <summary>
        /// 获得hash型key某个字段的值
        ...
        {
            string value = RedisBase.Client.GetValueFromHash(key, field);
            return value;
        }
        ...
        {
            RedisBase.Client.SetEntryInHash(key, field, value);
        }
        /// <summary>
        ///使某个字段增加
        /// </summary>
        ...
        {
            RedisBase.Client.IncrementValueInHash(key, field, incre);
        ...
        {
            RedisBase.Client.AddItemToList(list, item);
        }
        /// <summary>
        ...
        //{
        //    RedisBase.Client.LPush(list, Encoding.Default.GetBytes(item));
        //}
        /// <summary>
        /// 从list类型数据读取所有成员
        /// </summary>
        ...
        {
            List<string> listMembers = RedisBase.Client.GetAllItemsFromList(list);
            return listMembers;
        }
        /// <summary>
        ...
        {
            string item = RedisBase.Client.GetItemFromList(list, index);
            return item;
        }
        /// <summary>
        /// 向列表底部（右侧）批量添加数据
        ...
        {
            RedisBase.Client.AddRangeToList(list, values);
        }
        /// <summary>
        /// 向集合中添加数据
        /// </summary>
        ...
        {
            RedisBase.Client.AddItemToSet(item, set);
        }
        /// <summary>
        /// 获得集合中所有数据
        /// </summary>
        ...
        {
            HashSet<string> items = RedisBase.Client.GetAllItemsFromSet(set);
            return items;
        }
        /// <summary>
        ...
        {
            HashSet<string> diff = RedisBase.Client.GetDifferencesFromSet(fromSet, toSet);
            return diff;
        }
        /// <summary>
        /// 获得所有集合的并集
        ...
        {
            HashSet<string> union = RedisBase.Client.GetUnionFromSets(set);
            return union;
        }
        /// <summary>
        /// 获得所有集合的交集
        ...
        {
            HashSet<string> inter = RedisBase.Client.GetIntersectFromSets(set);
            return inter;
        }
        /// <summary>
        /// 向有序集合中添加元素
        ...
        {
            RedisBase.Client.AddItemToSortedSet(set, value, score);
        }
        /// <summary>
        ...
        {
            long index = RedisBase.Client.GetItemIndexInSortedSetDesc(set, value);
            return index;
        }
        /// <summary>
        ...
        {
            long index = RedisBase.Client.GetItemIndexInSortedSet(set, value);
            return index;
        }
        /// <summary>
        /// 获得有序集合中某个值得分数
        ...
        {
            double score = RedisBase.Client.GetItemScoreInSortedSet(set, value);
            return score;
        }
        /// <summary>
        /// 获得有序集合中，某个排名范围的所有值
        ...
        {
            List<string> valueList = RedisBase.Client.GetRangeFromSortedSet(set, beginRank, endRank);
            return valueList;
        }
        /// <summary>
        ...
        {
            List<string> valueList = RedisBase.Client.GetRangeFromSortedSetByHighestScore(set, beginScore, endScore);
            return valueList;
        }
        /// <summary>
        ...
        {
            List<string> vlaueList = RedisBase.Client.GetRangeFromSortedSetByLowestScore(set, beginScore, endScore);
            return vlaueList;
        }
