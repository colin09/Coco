...
namespace com.wx.redis
{
    public class RedisSet
    {
        ...
        {
            RedisBase.Client.AddItemToSet(key, value);
        }
        /// <summary>
        /// key集合中添加list集合
        /// </summary>
        ...
        {
            RedisBase.Client.AddRangeToSet(key, list);
        }
        #endregion
        #region 获取
        /// <summary>
        ...
        {
            return RedisBase.Client.GetRandomItemFromSet(key);
        }
        /// <summary>
        /// 获取key集合值的数量
        /// </summary>
        ...
        {
            return RedisBase.Client.GetSetCount(key);
        }
        /// <summary>
        /// 获取所有key集合的值
        /// </summary>
        ...
        {
            return RedisBase.Client.GetAllItemsFromSet(key);
        }
        #endregion
        #region 删除
        /// <summary>
        ...
        {
            return RedisBase.Client.PopItemFromSet(key);
        }
        /// <summary>
        /// 删除key集合中的value
        /// </summary>
        ...
        {
            RedisBase.Client.RemoveItemFromSet(key, value);
        }
        #endregion
        #region 其它
        /// <summary>
        ...
        {
            RedisBase.Client.MoveBetweenSets(fromkey, tokey, value);
        }
        /// <summary>
        ...
        {
            return RedisBase.Client.GetUnionFromSets(keys);
        }
        /// <summary>
        ...
        {
            RedisBase.Client.StoreUnionFromSets(newkey, keys);
        }
        /// <summary>
        ...
        {
            RedisBase.Client.StoreDifferencesFromSet(newkey, fromkey, keys);
        }
        #endregion
    }
}
