...
{
   public class HUserCountMap : EntityTypeConfiguration<UserCountEntity>
    {
        public HUserCountMap()
        {
            this.ToTable("H_UserCount");
            ...
            this.Property(h => h.PropertyType).HasColumnName("PropertyType").IsRequired();
            this.Property(h => h.PropertyValue).HasColumnName("PropertyValue").IsRequired();
